...
def go(args):
    ...
    artifact = wandb.Artifact(
        ...
        type="model_export",
        description="Random forest model for NYC Airbnb price prediction",
        metadata=rf_config
    )
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    reshape_to_1d = FunctionTransformer(reshape_1d, validate=False)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train a RandomForest regressor on the cleaned Airbnb dataset")
